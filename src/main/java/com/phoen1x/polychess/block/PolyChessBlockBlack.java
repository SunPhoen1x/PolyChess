...
public class PolyChessBlockBlack extends LeavesBlock implements BarrierBasedWaterloggable, FactoryBlock {

    protected ItemStack CHESS_MODEL;

    public PolyChessBlockBlack(Settings settings, String path) {
        super(settings);
