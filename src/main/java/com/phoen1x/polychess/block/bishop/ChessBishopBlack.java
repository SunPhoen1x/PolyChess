...
import com.phoen1x.polychess.entity.ChessBishopBlackBlockEntity;
...
public class ChessBishopBlack extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    public static final DirectionProperty FACING;
    public static final MapCodec<ChessBishopBlack> CODEC;
    private Model model;

    static {
        FACING = Properties.HORIZONTAL_FACING;
        CODEC = createCodec(ChessBishopBlack::new);
    }

    public ChessBishopBlack(Settings settings) {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ChessBishopBlackBlockEntity(pos, state);
    }
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack MODEL = BaseItemProvider.requestModel(Identifier.of(PolyChess.MOD_ID, "block/chess_bishop_black"));
