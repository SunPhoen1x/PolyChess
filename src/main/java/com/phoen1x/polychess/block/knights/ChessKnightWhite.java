...
import com.phoen1x.polychess.entity.ChessKnightWhiteBlockEntity;
...
public class ChessKnightWhite extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ChessKnightWhiteBlockEntity(pos, state);
    }
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack MODEL = BaseItemProvider.requestModel(Identifier.of(PolyChess.MOD_ID, "block/chess_knight_white"));
