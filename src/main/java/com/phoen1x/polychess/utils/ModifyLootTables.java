...
public class ModifyLootTables {
    ...
    public static void modifyLootTables(){
        // Перевіряємо, чи увімкнена генерація луту в структурах через конфіг.
        // Якщо enableStructureLootGeneration є false (що є значенням за замовчуванням),
        // то модифікації таблиць луту не будуть застосовані.
        if (!PolyChessConfig.getInstance().enableStructureLootGeneration) {
            System.out.println("PolyChess: Structure loot generation is disabled by config.");
            return; // Виходимо з методу, якщо вимкнено
        }
